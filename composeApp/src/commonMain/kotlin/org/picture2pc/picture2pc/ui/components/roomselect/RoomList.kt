...
import picture2pc.composeapp.generated.resources.room_select_room_name_input
import picture2pc.composeapp.generated.resources.room_select_rooms

@Composable
fun RoomList() {
    //TODO: Replace with focus manager from viewmodel
    ...
    Column(
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(Spacer.Small)) {
            PictureInput(
