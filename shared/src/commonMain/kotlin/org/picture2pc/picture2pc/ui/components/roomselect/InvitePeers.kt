...
import picture2pc.shared.generated.resources.group_add
import picture2pc.shared.generated.resources.keyboard_arrow_down
import picture2pc.shared.generated.resources.keyboard_arrow_right
import picture2pc.shared.generated.resources.room_select_invite_peers

@Composable
fun InvitePeers(modifier: Modifier = Modifier, alwaysExpanded: Boolean = false) {
    Column(
        modifier = modifier
            .fillMaxWidth()
        ...
        val expanded = alwaysExpanded || userExpanded
